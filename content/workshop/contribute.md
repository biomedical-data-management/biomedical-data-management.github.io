...
The final meta-review and acceptance decision will be made by the workshop chairs.

Accepted submissions will be invited to submit a camera-ready version as well as an associated blog. The camera-ready
version will be included in the workshop proceedings and hosted on OpenReview.
The blog post will be hosted on this community website and will serve as an easy-to-digest artifact.
...
* **Mind the (language) gap:** Communicating across different scientific domains is no easy task.
In order to maximize understanding between communities, we encourage
...
online initiatives aimed at sparking productive joint efforts.
